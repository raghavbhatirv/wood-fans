...
function Checkout() {
  ...
  return (
    <div className="flex justify-center bg-gray-300">
      <div className="w-4/6 bg-white rounded-3xl p-10 my-5">
        <div>
        ...
        <div className="px-2 py-5">
          <form className="space-y-4">
            ...
            <input
              type="submit"
              value="Submit"
              className="w-full p-2 rounded-lg bg-primary-yellow text-light-gray hover:cursor-pointer font-semibold text-lg"
            />
          </form>
        </div>
      </div>
